package com.ataste.ataste.config;

import com.ataste.ataste.security.jwt.exception.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .mvcMatchers( "/members/signup", "/members/login", "/members/refreshToken", "/search/{location}").permitAll()
